    ...
    extends FileSystem
{
    ...
    protected AbstractFileSystem(final PathElementsFactory factory)
    {
     ...
     * pattern
     *
     * @throws IllegalArgumentException If the parameter does not take the
     * form: {@code syntax:pattern}
