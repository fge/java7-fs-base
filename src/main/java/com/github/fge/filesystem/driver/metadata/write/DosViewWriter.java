...
public final class DosViewWriter
    extends ViewWriterFixedNames<DosFileAttributeView>
{
    public DosViewWriter(final DosFileAttributeView view)
    {
        super(view, "lastModifiedTime", "lastAccessTime", "creationTime",
            "size", "isRegularFile", "isDirectory", "isSymbolicLink", "isOther",
            "fileKey", "readonly", "system", "hidden", "archive");
    }
