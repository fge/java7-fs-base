...
public final class DosAttributesTest
    extends AttributesTest<DosAttributes<Object>>
{
    @Override
    ...
    public void init()
    {
        ...
        attributes = spy(new DosAttributes<Object>(pathMetadata)
        {
        });
        ...
        bool = true;
        values.put(name, bool);
        doReturn(bool).when(attributes).isReadOnly();

        name = "archive";
        bool = false;
        values.put(name, bool);
        doReturn(bool).when(attributes).isArchive();

        name = "system";
        bool = true;
        values.put(name, bool);
        doReturn(bool).when(attributes).isSystem();

        name = "hidden";
        bool = false;
        values.put(name, bool);
        doReturn(bool).when(attributes).isHidden();
    }
    ...
    {
        final Object byName = attributes.getAttributeByName("readonly");

        final Object byMethod = values.get("readonly");

        verify(attributes).isReadOnly();
    ...
    {
        final Object byName = attributes.getAttributeByName("system");

        final Object byMethod = values.get("system");

        verify(attributes).isSystem();
    ...
    {
        final Object byName = attributes.getAttributeByName("archive");

        final Object byMethod = values.get("archive");

        verify(attributes).isArchive();
    ...
    {
        final Object byName = attributes.getAttributeByName("hidden");

        final Object byMethod = values.get("hidden");

        verify(attributes).isHidden();
